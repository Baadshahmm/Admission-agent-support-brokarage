...
<body>
 ...
 $connect = mysqli_connect("localhost", "root", "", "univpedia");  
      ...
      $query = "update student_doc set `ielts`= '$file' where `id`='$id'";  
      if(mysqli_query($connect, $query))  
      {  
           echo '<script>alert("IELTS result Inserted into Database")</script>';  
      }  
...
<div class="container" style="width:100%;">  
                ...
                <br />  
                <form method="post" action="doc8.php" enctype="multipart/form-data">  
