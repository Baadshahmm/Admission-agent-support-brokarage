...
<body>
 ...
 $connect = mysqli_connect("localhost", "root", "", "univpedia");  
      ...
      $query = "INSERT INTO student_doc(`id`,`passport`) VALUES ('$id','$file')";  
      if(mysqli_query($connect, $query))  
      {  
           echo '<script>alert("Passport Inserted into Database")</script>';
      }  
   
 ?>  
<br><br><br><br>
<div class="container" style="width:100%;">  
                <h1 align="center">Insert transcript Here</h1>  
                <br />  
